...
public class YestrdayAdapter extends RecyclerView.Adapter<YestrdayAdapter.FAQViewHolder> {

    private final String TAG = YestrdayAdapter.class.getSimpleName();
    ...
    public YestrdayAdapter(Context context)
    {
        mContext = context;
    ...
    public FAQViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return  new FAQViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.yestrdayreport, parent, false), viewType);
